...
Pitchfork describes itself to advertisers as "the most trusted voice in music" [@Pitchforka]. Nonetheless, its influence is difficult to quantify. As [@robettePitchforkPravdaIndie2016] writes, "criticism is part of an ensemble of practices of intermediation" (p. 121). He and [@beck2011] cite the same two examples---a 9.7 score for the Arcade Fire [@mooreArcadeFireFuneral2004] and an 0.0 for Travis Morrison [@dahlenTravisMorrisonTravistan2004]---for how the site's reviews could affect each artists' careers.

While [@robettePitchforkPravdaIndie2016] describes how Pitchfork transmitted its influence through other sections of the music industry such as record stores, labels, and other magazines (pp. 123--4), and produces a multiple correspondence analysis showing an increasing overlap between albums cited in Pitchfork's year-end lists and those of other publications (pp. 133--5).  [@beck2011] notes how the decline of these institutions, amid the rise of digital music platforms, only amplified Pitchfork's influence: "In the 21st century, we are all record store clerks" (p. 179).

There is a paradox, however, at the root of this influence. As [@frithSoundEffectsYouth1981] puts it, "it's the writers' independence from record company influence that gives good reviewers their authenticity" (p. 174). The loyalty commanded by any critic depends equally on her independence from prevailing tastes, and her reliability in satisfying the tastes of her readership. This paradox is only amplified in the field of rock music, and even more so in indie rock---forms that embody "a tension between the music's aspirations to art and its reality of being a mass, commercial culture" [@hamiltonJustMidnightRock2016, p. 80]. Moreover, "underground papers were important as the source of what become the dominant ideology of rock" ([@frithSoundEffectsYouth1981] p. 169).

# Theoretical framework

Frith's description of the professionalization of *Rolling Stone* magazine in the 1970s, as it "became integrated into the American music business" (p. 170) anticipates Pitchfork's trajectory in the 2000s. [@robettePitchforkPravdaIndie2016] notes that, between 2003 and 2013, the share of Billboard-charting albums on Pitchfork's year-end lists increased from 17 to 30%. He proposes "a movement of convergence between Pitchfork and the modal taste" (p. 131).
...
This shift can be described by ideological as much as by mercenary reasons. In the period described by this study, numerous critics identified a shift in elite musical ideology---what [@petersonChangingHighbrowTaste1996a] call "from snob to omnivore" (1996). Petersen and Kern suggest five possible causes for this shift: "structural change" (whereby geographic migration and mass media expose listeners to other cultures), "value change" (the abandonment of status hierarchies of gender, race, religion, and ethnicity), "art-world change" (a shift from conservatizing to "avant-guardist" [sic] ideologies), and "generational politics" (the baby boomers' continued attachment to the culture of their youth) (p. 905).

Beck drolly charts the broadening of Pitchfork's coverage beyond white suburban indie rock to include rap, jazz ("'Trane takes it to heaven and back with some style, man" [@schreiberJohnColtraneLive1999), and dance music ("You people at shows who don't dance, who don't know a good time, who can't have fun, who sneer and scoff at the supposed inferior---it's you this music strikes a blow against" [@schreiberRaptureEchoes2003]).
...
* proportion of charting albums covered by pitchfork
* limit to albums charting above a certain rank
* disaggregate by time of coverage: whether the album charted before or after publication
* look at weeks before/after publication
* billboard changed formula december 2014
